...
- Child Applications reference chart paths under **`hub-clusters/day2/applications/…`** or **`cluster-automation/spoke-automation/…`** and pull **`hub-clusters/day2/99-environments/.../values.yaml`**.
...
- [day2/99-environments/README.md](day2/99-environments/README.md)
